...
LRESULT WindowImplBase::OnNcHitMainWindow(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT WindowImplBase::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_NCHITTEST:		lRes = OnNcHitMainWindow(uMsg, wParam, lParam, bHandled); break;
